...
const FormCodeChoices = () => {
  ...
  const [classification, setClassification] = useState("Non-LNP-Guest");
  ...
  return (
    <div className="flex flex-col m-10 h-screen">
      <header className="text-blue-900 py-4 text-center">
        <h1 className="lg:text-8xl text-5xl font-semibold">REGISTRATION</h1>
      </header>
      <div className="flex flex-col sm:flex-row flex-grow justify-center items-center">
        {/* Center header vertically and horizontally */}
        <div className="flex justify-center items-center flex-grow">
          {/* Center the form horizontally */}
          <div className="flex justify-center items-center flex-col w-full sm:max-w-sm md:max-w-md lg:max-w-lg">
            <div className="flex items-center">
              <img
                className="hidden lg:inline h-auto lg:w-40 mr-4"
                src="/qr_pathways.png"
                alt="Pathways Choices"
              />
            </div>

            {/* Limit form width for different screen sizes */}
              ...
              >
                ...
                {selectedName ? (
                      ...
                      eventDetails.summary && (
                        <div className="bg-white rounded-lg shadow-lg p-4 mt-4 text-center border border-red-100">
                          <p className="text-xl font-blue-100 font-italic">
                            We have already recorded your attendance for today's
                            event!
                          </p>
                        </div>
                      )}
                  ...
                  <>
                    ...
                    <div className="mb-8 border border-green-500 p-4 rounded-lg hidden">
                      <div className="mb-4">
                        {/* <label
                    className="block text-gray-700 text-sm font-bold mb-2"
                  ...
                  >
                    Classification
                      ...
                      <p className="text-sm text-gray-600 italic hidden">
...
export default FormCodeChoices;
